    ...
    *** Mutually exclusive with --disable-chap ***""", action='store_true')
    ...
    def sock_impl_set_options(args):
        rpc.sock.sock_impl_set_options(args.client,
                                       ...
                                       enable_new_session_tickets=args.enable_new_session_tickets)
    ...
    p.add_argument('--enable-new-session-tickets', help='Enable NewSessionTicket messages',
                   action='store_true', dest='enable_new_session_tickets')
    p.add_argument('--disable-new-session-tickets', help='Disable NewSessionTicket messages',
                   action='store_false', dest='enable_new_session_tickets')
