...
for io in "${xnvme_io[@]}"; do
	...
	for cc in "${xnvme_conserve_cpu[@]}"; do
		...
		run_test "xnvme_rpc_${io}_${cc}" xnvme_rpc               # xnvme.tests
		run_test "xnvme_bdevperf_${io}_${cc}" xnvme_bdevperf     # xnvme.tests
		run_test "xnvme_fio_plugin_${io}_${cc}" xnvme_fio_plugin # xnvme.tests
	done
done
