...
rpc_cmd nvmf_discovery_add_referral -t $TEST_TRANSPORT -a $NVMF_REFERRAL_IP_1 -s $NVMF_PORT_REFERRAL -w
rpc_cmd nvmf_discovery_add_referral -t $TEST_TRANSPORT -a $NVMF_REFERRAL_IP_2 -s $NVMF_PORT_REFERRAL -w
rpc_cmd nvmf_discovery_add_referral -t $TEST_TRANSPORT -a $NVMF_REFERRAL_IP_3 -s $NVMF_PORT_REFERRAL -w
...
rpc_cmd nvmf_discovery_add_referral -t $TEST_TRANSPORT -a $NVMF_REFERRAL_IP_1 \
	-s $NVMF_PORT_REFERRAL -n discovery -w
rpc_cmd nvmf_discovery_add_referral -t $TEST_RANSPORT -a $NVMF_REFERRAL_IP_1 \
	-s $NVMF_PORT_REFERRAL -n "$NQN" -w
