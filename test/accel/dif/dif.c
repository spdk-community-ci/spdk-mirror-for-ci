...
static int
get_dif_strip_alloc_bufs(struct dif_task *task, uint32_t chained_count)
{
...
static int
get_dif_strip_free_bufs(struct dif_task *task)
{
	uint32_t i = 0;
...
static void
accel_dif_strip_test(void *arg)
{
	int rc;
	struct accel_dif_request *req = arg;

	g_completion_success = false;
	rc = spdk_accel_submit_dif_strip(req->channel, req->dst_iovs, req->dst_iovcnt,
...
static void
accel_dif_strip_op_dif_generated_do_check(uint32_t dif_flags)
{
	struct spdk_dif_ctx_init_ext_opts dif_opts;
	struct accel_dif_request req;
	struct dif_task *task = &g_dif_task;
	...
	rc = get_dif_strip_alloc_bufs(task, 1);
	CU_ASSERT(rc == 0);
	...
	execute_spdk_function(accel_dif_strip_test, &req);
	CU_ASSERT_EQUAL(g_completion_success, true);

	get_dif_strip_free_bufs(task);
}

static void
accel_dif_strip_op_dif_generated_guard_check(void)
{
	accel_dif_strip_op_dif_generated_do_check(SPDK_DIF_FLAGS_GUARD_CHECK);
}

static void
accel_dif_strip_op_dif_generated_apptag_check(void)
{
	accel_dif_strip_op_dif_generated_do_check(SPDK_DIF_FLAGS_APPTAG_CHECK);
}

static void
accel_dif_strip_op_dif_generated_reftag_check(void)
{
	accel_dif_strip_op_dif_generated_do_check(SPDK_DIF_FLAGS_REFTAG_CHECK);
}

static void
accel_dif_strip_op_dif_not_generated_do_check(uint32_t dif_flags)
{
	struct spdk_dif_ctx_init_ext_opts dif_opts;
	struct accel_dif_request req;
	struct dif_task *task = &g_dif_task;
...
static void
accel_dif_strip_op_dif_not_generated_guard_check(void)
{
	accel_dif_strip_op_dif_not_generated_do_check(SPDK_DIF_FLAGS_GUARD_CHECK);
}

static void
accel_dif_strip_op_dif_not_generated_apptag_check(void)
{
	accel_dif_strip_op_dif_not_generated_do_check(SPDK_DIF_FLAGS_APPTAG_CHECK);
}

static void
accel_dif_strip_op_dif_not_generated_reftag_check(void)
{
	accel_dif_strip_op_dif_not_generated_do_check(SPDK_DIF_FLAGS_REFTAG_CHECK);
}
...
setup_accel_tests(void)
{
	...
	if (CU_add_test(suite, "verify: DIF generated, GUARD check",
	    ...
	    CU_add_test(suite, "strip: DIF generated, GUARD check",
			accel_dif_strip_op_dif_generated_guard_check) == NULL ||
	    CU_add_test(suite, "strip: DIF generated, APPTAG check",
			accel_dif_strip_op_dif_generated_apptag_check) == NULL ||
	    CU_add_test(suite, "strip: DIF generated, REFTAG check",
			accel_dif_strip_op_dif_generated_reftag_check) == NULL ||

	    CU_add_test(suite, "strip: DIF not generated, GUARD check",
			accel_dif_strip_op_dif_not_generated_guard_check) == NULL ||
	    CU_add_test(suite, "strip: DIF not generated, APPTAG check",
			accel_dif_strip_op_dif_not_generated_apptag_check) == NULL ||
	    CU_add_test(suite, "strip: DIF not generated, REFTAG check",
			accel_dif_strip_op_dif_not_generated_reftag_check) == NULL ||
