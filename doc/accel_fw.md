...
The AE4DMA module enables SPDK applications to offload memory-to-memory copy operations to
the AE4DMA engines on AMD EYPC (Embedded 4th Generation SoCs) systems.
