		     ...
		     const struct spdk_json_val *params)
{
	...
	for (i = 0; i < num_base_bdevs; i++) {
		...
		rc = raid_bdev_add_base_bdev(raid_bdev, base_bdev_name, false,
			    ...
			    const struct spdk_json_val *params)
{
	...
	rc = raid_bdev_add_base_bdev(raid_bdev, req.base_bdev, req.skip_rebuild,
