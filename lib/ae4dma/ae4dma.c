		       ...
		       void *dst, const void *src, uint64_t nbytes)
{
	...
	uint64_t vdst, vsrc, dst_len, src_len;
	...
	if (cb_desc) {
		...
		/*
		 * Ran out of descriptors in the ring.
		 */
