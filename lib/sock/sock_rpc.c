			  ...
			  const struct spdk_json_val *params)
{
	...
	spdk_json_write_named_bool(w, "enable_new_session_tickets", sock_opts.enable_new_session_tickets);
...
static const struct spdk_json_object_decoder rpc_sock_impl_set_opts_decoders[] = {
	...
	{
		"enable_new_session_tickets", offsetof(struct spdk_rpc_sock_impl_set_opts, sock_opts.enable_new_session_tickets),
		spdk_json_decode_bool, true
	}
};
