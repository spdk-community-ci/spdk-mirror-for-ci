 ...
 * request submission.
 */
typedef void (*spdk_ae4dma_req_cb)(void *arg);
 ...
 */
int spdk_ae4dma_build_copy(struct spdk_ae4dma_chan *chan,
 ...
 */
int spdk_ae4dma_process_events(struct spdk_ae4dma_chan *chan);
 ...
 */
uint32_t spdk_ae4dma_get_dma_capabilities(struct spdk_ae4dma_chan *chan);
