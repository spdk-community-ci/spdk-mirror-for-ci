 ...
 * \param dst 4K aligned Destination virtual address.
 * \param src 4K aligned Source virtual address.
 * \param nbytes Number of bytes to copy.
 *
 * \return 0 on success, negative errno on failure.
 */
int spdk_ae4dma_build_copy(struct spdk_ae4dma_chan *chan, int hwq_id,
