...
#define AE4DMA_DWORD0_SOC	BIT(0)
#define AE4DMA_DWORD0_IOC	BIT(1)
#define AE4DMA_DWORD0_SOM	BIT(3)
#define AE4DMA_DWORD0_EOM	BIT(4)
#define AE4DMA_DWORD0_DMT	GENMASK(5, 4)
#define AE4DMA_DWORD0_SMT	GENMASK(7, 6)

#define AE4DMA_DWORD0_DMT_MEM	0x0
#define AE4DMA_DWORD0_DMT_IO	1<<4
#define AE4DMA_DWORD0_SMT_MEM	0x0
#define AE4DMA_DWORD0_SMT_IO	1<<6
