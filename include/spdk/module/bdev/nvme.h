 ...
 * \param drv_opts NVMe driver options.
 * \param bdev_opts NVMe bdev options.
 * \param timeout Time to wait until the discovery and all discovered NVMe subsystems are attached
 * \param from_mdns Whether to use Multicast DNS for NVMe subsystems discovery
